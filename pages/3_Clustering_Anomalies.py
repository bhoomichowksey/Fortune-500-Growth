"""pages/3_Clustering_Anomalies.py — KMeans performance segmentation + IsolationForest anomaly detection."""
...
st.set_page_config(page_title="Clustering & Anomalies", page_icon="🧭", layout="wide")
